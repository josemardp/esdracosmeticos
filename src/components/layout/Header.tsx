        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              <Button variant="ghost" size="icon" className="text-foreground" aria-label="Buscar">
                <Search className="w-4 h-4" />
              </Button>
              <Link to="/favoritos">
                <Button variant="ghost" size="icon" className="text-foreground" aria-label="Favoritos">
              ...
              <Link to="/conta">
                <Button variant="ghost" size="icon" className="text-foreground" aria-label="Minha Conta">

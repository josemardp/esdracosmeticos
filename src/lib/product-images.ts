export function getProductImage(slug: string, coverImage: string | null): string {
  ...
  switch (slug) {
    ...
    case "mascara-de-cilios-super-brown-niina-secrets-neutrals-10g":
    ...
    case "locao-hidratante-desodorante-corporal-dr-botica-pocao-das-nuvens-400ml":
    ...
    case "mascara-de-cilios-turbo-dimension-eudora-make-10g":
    ...
    case "creme-hidratante-desodorante-corporal-instance-baunilha-400ml":

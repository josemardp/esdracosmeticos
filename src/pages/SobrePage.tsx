  ...
  return (
    <div className="py-12 lg:py-20">
      <div className="container mx-auto px-4">
        {/* Hero */}
        <m.div className="text-center max-w-3xl mx-auto mb-16" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-16">
          {[
            ...
            <m.div key={v.title} className="bg-card border rounded-xl p-6 lg:p-8 text-center" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}>
        ...
        {/* Timeline */}
        <m.div className="max-w-2xl mx-auto mb-16" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
          ...
          <div className="relative">
            ...
            {milestones.map((ms, i) => (
              <m.div key={ms.year} className="relative flex items-start gap-6 mb-8 lg:mb-10" initial={{ opacity: 0, x: i % 2 === 0 ? -20 : 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}>
                ...
                <div className="flex-1 lg:w-[calc(50%-2rem)] lg:ml-auto lg:pl-10 bg-card border rounded-xl p-4">
                  <span className="font-body text-xs text-primary font-semibold">{ms.year}</span>
                  <p className="font-body text-sm text-foreground mt-1 leading-relaxed">{ms.text}</p>
                </div>
              </m.div>
            ))}
          </div>
        ...
        {/* Info */}
        <m.div className="bg-secondary rounded-xl p-8 lg:p-12 text-center max-w-2xl mx-auto" initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
